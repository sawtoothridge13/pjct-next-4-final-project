    ...
    <div className={styles.heroArea}>
      <main className={`${styles.main} ${styles.contentWrapper}`}>
        ...
        <h2 className={styles.h2}>
          ...
          place.
          <br />
          With a user-friendly interface, it's easy to navigate through past
          trips, search by date or location, and relive cherished memories.
          <br />
          ...
          <br />
          Additionally, Trip Tracker serves as a virtual photo album, where
          users can upload, organize, and share their travel photos.
          <br />
          It's the perfect tool for travel enthusiasts to keep their memories
          organized and inspire future adventures.
        </h2>
      </main>
    </div>
  );
